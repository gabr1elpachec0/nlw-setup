    ...
    <form className="w-full flex flex-col mt-6" onSubmit={createNewHabit}>
      ...
      <div className="flex flex-col gap-2 mt-3">
        {availableWeekDays.map((weekDay, index) => (
          ...
          >
            <div className='h-8 w-8 rounded-lg flex items-center justify-center bg-zinc-900 border-2 border-zinc-800 group-data-[state=checked]:bg-green-500 group-data-[state=checked]:border-green-500 transition-colors group-focus:ring-2 group-focus:ring-violet-700 focus:ring-offset-2 focus:ring-offset-zinc-900'>
              <Checkbox.Indicator>
